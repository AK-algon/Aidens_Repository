...
public class MessageListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        public void notifyMessageDeleted(ChatMessage chosenMessage, int chosenPosition) {
            ...
            builder.setMessage("Do you want to delete the message: " + chosenMessage.getMessage())//messageText.getText())
                    .setTitle("Danger!")
                    .setNegativeButton("Cancel", (dialog, c) -> {})
                    .setPositiveButton("Delete", (Dialog, cl) -> {
                        ChatMessage removedMessage = messages.get(chosenPosition); //messages.get(position);
